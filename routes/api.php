...
| Windows PC. No session, no CSRF — the shared secret in CP_SHORTCUT_TOKEN
| (header X-Shortcut-Token or Authorization: Bearer) is the whole auth story.
| Still LAN/tailnet-gated by the same middleware as the dashboard.
*/
Route::middleware(['lan', 'shortcut'])->prefix('shortcut')->group(function () {
